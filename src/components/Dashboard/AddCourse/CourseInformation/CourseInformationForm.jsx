...
import {setStep,setCourse} from "../../../../../src/slices/courseSlice"
...
const CourseInformationForm=()=>{
   ...
   const {register,handleSubmit,setValue,getValues, formState: { errors },} =useForm();
    ...
    // course ke slice se kuch cheezein fetch kr li
     const { course, editCourse } = useSelector((state) => state.course)
    
    const [loading,setLoading]=useState(false);

    /* to hum course ki categories ke loye ek drop down meenu denge to uss drop down menu se konsi 
       konsi caetgoriesd aayengi vo ek variable mei store krni padengi*/
       ...
       useEffect(()=>{
            ...
            const getCategories=async()=>{
                 ...
                 // agar categories ki length "0" se badhkar hongi mtlb categories mei kuch hoga to CourseCategory set krdo
    ...
    //Form submit hone ke baad ye function chala do

       const onSubmit=async(data)=>{
               
                 {/* submit par click krne ke 2 scenarios ho skte hai 1) course edit krne aaya hun
                  2) course ko create krne aaya hun */}
           
            // a) if we are editing the course
              ...
              className="space-y-8 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6">
               ...
               <div className="flex flex-col space-y-2">
                       ...
                       <input id="courseTitle"
                         ...
                         {/* agar corse title mei kuch error aa jaye to... */}
                          {
                                errors.courseTitle && (
                ...
                <div className=" flex flex-col space-y-2">
                 ...
                 {/* category drop down menu */}
                    ...
                    <div  className="flex flex-col space-y-2">
                     ...
                     {/* custom component for handeling tags input */}
                     ...
                     {/* component a component for uploading and previewing thumbnail*/}
                    ...
                    <div className="flex flex-col space-y-2">
                     ...
                     <RequirementFeild name="courseRequirements"
