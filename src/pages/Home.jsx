     ...
     return(
        <div className=""> 
              ...
              <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
                     {/* a) Become Instructor wala button */}
                     ...
                     <div className="w-[80%] place-self-center text-lg mt-4 font-bold text-richblack-300">
                          With our online coding courses, you can learn at your own pace, from anywhere in the world, and get access to a wealth of resources, including hands-on projects, quizzes, and personalized feedback from instructors.
                     </div>

                     {/* Buttons  */}

                     <div className="flex flex-row gap-7 mt-8 place-self-center">
                     ...
                     {/* Video  */}
                      <div className="mx-3 my-14 shadow-[10px_-5px_50px_-5px] shadow-blue-200 w-full max-w-5xl h-auto place-self-center">
               ...
               {/* Section 2 - white background wala */}
